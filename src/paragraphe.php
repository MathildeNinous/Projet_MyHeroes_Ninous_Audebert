    ...
    <div class="container paragraphe">
        ...
        <div class="row m-3">
            <?php 
                ...
                <a class="choix" style="text-decoration:none;" href="paragraphe.php?id=<?=$choix['IdParagrapheSortant']?>&titre=<?=$histoire['Titre']?>">
                    <div class="col-12 infoClick" style="width:100%; background-color:#A2D9CE;">
